        ...
        <div className="flex items-center gap-2 md:gap-4">
          <Link to="/notifications" className="relative">
            ...
            >
              ...
              <Badge className="absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center bg-findom-purple text-white">
                3
              </Badge>
            </Button>
          </Link>
          ...
          <Button
            variant="outline"
            asChild
            className="border-findom-purple/60 hover:bg-findom-purple/20 transition-colors"
          >
